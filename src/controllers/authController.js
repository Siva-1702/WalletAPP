...
const googleStart = (mode) => {
  if (!env.googleClientId || !env.googleClientSecret) {
    throw new ApiError(503, `Google OAuth is not configured. GOOGLE_CLIENT_ID source: ${env.envDiagnostics.googleClientIdSource}, GOOGLE_CLIENT_SECRET source: ${env.envDiagnostics.googleClientSecretSource}. Ensure values are non-empty in .env and restart the server.`);
  }
